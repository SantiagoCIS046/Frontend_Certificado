      ...
      <section class="form-section">
        ...
        <div class="form-box">
          <div class="form-grid">
            ...
            <div class="input-group col-6">
              <label>EPS</label>
              <input type="text" v-model="formData.eps" placeholder="Nombre de su EPS" :disabled="readOnly" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="detail-box">
        ...
        <div class="form-grid">
          <div class="input-group col-6">
            <label>Mes</label>
            <div class="select-wrapper">
              <select v-model="formData.month" :disabled="readOnly">
          ...
          <div class="input-group col-6">
            <label>Año</label>
            <div class="select-wrapper">
              <select v-model="formData.year" :disabled="readOnly">
...
const handleSend = () => {
  alert('Solicitud Enviada con éxito (Asopagos)');
